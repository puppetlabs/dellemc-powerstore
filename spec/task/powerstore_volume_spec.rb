...
definition_name = 'powerstore_volume'

describe "#{definition_name}" do
  it 'should perform volume_collection_query' do
    task_name = 'powerstore::powerstore_volume_collection_query'
