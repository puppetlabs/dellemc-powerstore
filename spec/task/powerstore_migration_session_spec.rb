...
definition_name = 'powerstore_migration_session'

describe "#{definition_name}" do
  it 'should perform migration_session_collection_query' do
    task_name = 'powerstore::powerstore_migration_session_collection_query'
  ...
  it 'should perform migration_session_instance_query' do
    task_name = 'powerstore::powerstore_migration_session_instance_query'
  ...
  it 'should perform migration_session_delete' do
    task_name = 'powerstore::powerstore_migration_session_delete'
    result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
    expect(result[0]['status']).to eq('success')  
	end
