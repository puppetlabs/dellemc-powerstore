...
definition_name = 'powerstore_smb_share'

describe "#{definition_name}" do
  it 'should perform smb_share_collection_query' do
    task_name = 'powerstore::powerstore_smb_share_collection_query'
  ...
  it 'should perform smb_share_instance_query' do
    task_name = 'powerstore::powerstore_smb_share_instance_query'
  ...
  it 'should perform smb_share_delete' do
    task_name = 'powerstore::powerstore_smb_share_delete'
    result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
    expect(result[0]['status']).to eq('success')  
	end
