...
definition_name = 'powerstore_volume_group'

describe "#{definition_name}" do
  it 'should perform volume_group_collection_query' do
    task_name = 'powerstore::powerstore_volume_group_collection_query'
  ...
  it 'should perform volume_group_instance_query' do
    task_name = 'powerstore::powerstore_volume_group_instance_query'
  ...
  it 'should perform volume_group_delete' do
    task_name = 'powerstore::powerstore_volume_group_delete'
    result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
    expect(result[0]['status']).to eq('success')  
	end
