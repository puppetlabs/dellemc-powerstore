...
definition_name = 'powerstore_storage_container'

describe "#{definition_name}" do
  it 'should perform storage_container_collection_query' do
    task_name = 'powerstore::powerstore_storage_container_collection_query'
  ...
  it 'should perform storage_container_instance_query' do
    task_name = 'powerstore::powerstore_storage_container_instance_query'
  ...
  it 'should perform storage_container_delete' do
    task_name = 'powerstore::powerstore_storage_container_delete'
    result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
    expect(result[0]['status']).to eq('success')  
	end
