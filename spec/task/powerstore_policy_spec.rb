...
definition_name = 'powerstore_policy'

describe "#{definition_name}" do

  it 'should perform policy_collection_query' do
      task_name = 'powerstore::powerstore_policy_collection_query'
  ...
  it 'should perform policy_instance_query' do
      task_name = 'powerstore::powerstore_policy_instance_query'
  ...
  it 'should perform policy_delete' do
      task_name = 'powerstore::powerstore_policy_delete'
      result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
      expect(result[0]['status']).to eq('success')  
	end  
