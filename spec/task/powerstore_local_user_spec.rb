...
definition_name = 'powerstore_local_user'

describe "#{definition_name}" do
  it 'should perform local_user_collection_query' do
    task_name = 'powerstore::powerstore_local_user_collection_query'
  ...
  it 'should perform local_user_instance_query' do
    task_name = 'powerstore::powerstore_local_user_instance_query'
  ...
  it 'should perform local_user_delete' do
    task_name = 'powerstore::powerstore_local_user_delete'
    result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
    expect(result[0]['status']).to eq('success')  
	end
