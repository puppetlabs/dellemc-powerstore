...
definition_name = 'powerstore_vcenter'

describe "#{definition_name}" do

  it 'should perform vcenter_collection_query' do
      task_name = 'powerstore::powerstore_vcenter_collection_query'
  ...
  it 'should perform vcenter_instance_query' do
      task_name = 'powerstore::powerstore_vcenter_instance_query'
  ...
  it 'should perform vcenter_delete' do
      task_name = 'powerstore::powerstore_vcenter_delete'
      result = run_task(task_name, 'prism', {"id" => "string"}, config: config_data, inventory: inventory_data)
      expect(result[0]['status']).to eq('success')  
	end  
