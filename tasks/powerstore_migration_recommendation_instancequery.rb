...
class Migration_recommendationInstancequeryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/api/rest/migration_recommendation/%{id}'
  ...
  if __FILE__ == $0
    Migration_recommendationInstancequeryTask.run
  end
