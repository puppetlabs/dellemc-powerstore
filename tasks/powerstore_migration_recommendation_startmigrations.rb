...
class Migration_recommendationStartmigrationsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/migration_recommendation/%{id}/start_migration_sessions'
  ...
  if __FILE__ == $0
    Migration_recommendationStartmigrationsTask.run
  end
