...
class Import_unityDiscovertheimportablevolumesandconsistencygroupsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_unity/%{id}/discover'
  ...
  if __FILE__ == $0
    Import_unityDiscovertheimportablevolumesandconsistencygroupsTask.run
  end
