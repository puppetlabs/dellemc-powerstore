...
class File_virus_checkerDownloadConfigFileTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/api/rest/file_virus_checker/%{id}/download_config'
  ...
  if __FILE__ == $0
    File_virus_checkerDownloadConfigFileTask.run
  end
