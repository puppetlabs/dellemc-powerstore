...
class Migration_recommendationCreatemigrationsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/migration_recommendation/%{id}/create_migration_sessions'
  ...
  if __FILE__ == $0
    Migration_recommendationCreatemigrationsTask.run
  end
