...
class File_virus_checkerUploadConfigFileTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/file_virus_checker/%{id}/upload_config'
  ...
  if __FILE__ == $0
    File_virus_checkerUploadConfigFileTask.run
  end
