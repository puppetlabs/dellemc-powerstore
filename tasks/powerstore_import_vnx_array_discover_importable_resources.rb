...
class Import_vnx_arrayDiscoverImportableResourcesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_vnx_array/%{id}/discover'
  ...
  if __FILE__ == $0
    Import_vnx_arrayDiscoverImportableResourcesTask.run
  end
