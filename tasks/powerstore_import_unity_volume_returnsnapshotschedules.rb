...
class Import_unity_volumeReturnsnapshotschedulesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_unity_volume/%{id}/import_snapshot_schedules'
  ...
  if __FILE__ == $0
    Import_unity_volumeReturnsnapshotschedulesTask.run
  end
