...
class Import_storage_centerDiscoverimportableresourcesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_storage_center/%{id}/discover'
  ...
  if __FILE__ == $0
    Import_storage_centerDiscoverimportableresourcesTask.run
  end
