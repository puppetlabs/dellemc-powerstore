...
class NetworkReconfigureclustermanagementnetworksettingsfromIPv4toIPv6orviceversa.Task < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/network/%{id}/replace'
  ...
  if __FILE__ == $0
    NetworkReconfigureclustermanagementnetworksettingsfromIPv4toIPv6orviceversa.Task.run
  end
