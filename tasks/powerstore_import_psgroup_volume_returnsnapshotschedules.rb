...
class Import_psgroup_volumeReturnsnapshotschedulesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_psgroup_volume/%{id}/import_snapshot_schedules'
  ...
  if __FILE__ == $0
    Import_psgroup_volumeReturnsnapshotschedulesTask.run
  end
