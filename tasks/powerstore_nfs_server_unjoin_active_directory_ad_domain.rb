...
class Nfs_serverUnjoinActiveDirectory(AD)DomainTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/nfs_server/%{id}/unjoin'
  ...
  if __FILE__ == $0
    Nfs_serverUnjoinActiveDirectory(AD)DomainTask.run
  end
