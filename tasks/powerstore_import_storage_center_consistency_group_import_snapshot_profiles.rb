...
class Import_storage_center_consistency_group_import_snapshot_profilesTask < TaskHelper
  ...
  if __FILE__ == $0
    Import_storage_center_consistency_group_import_snapshot_profilesTask.run
  end
