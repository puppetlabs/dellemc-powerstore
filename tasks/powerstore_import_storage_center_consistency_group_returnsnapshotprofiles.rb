...
class Import_storage_center_consistency_groupReturnsnapshotprofilesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_storage_center_consistency_group/%{id}/import_snapshot_profiles'
  ...
  if __FILE__ == $0
    Import_storage_center_consistency_groupReturnsnapshotprofilesTask.run
  end
