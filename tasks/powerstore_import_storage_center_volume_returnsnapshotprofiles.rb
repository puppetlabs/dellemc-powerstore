...
class Import_storage_center_volumeReturnsnapshotprofilesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_storage_center_volume/%{id}/import_snapshot_profiles'
  ...
  if __FILE__ == $0
    Import_storage_center_volumeReturnsnapshotprofilesTask.run
  end
