...
class Software_packagePre-UpgradeHealthCheckTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/software_package/%{id}/puhc'
  ...
  if __FILE__ == $0
    Software_packagePre-UpgradeHealthCheckTask.run
  end
