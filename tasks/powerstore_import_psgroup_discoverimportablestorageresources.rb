...
class Import_psgroupDiscoverimportablestorageresourcesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/api/rest/import_psgroup/%{id}/discover'
  ...
  if __FILE__ == $0
    Import_psgroupDiscoverimportablestorageresourcesTask.run
  end
