...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    location_history:          {
      type:      "Optional[Array[Struct[{Optional[to_appliance_id] => String, Optional[from_appliance_id] => String, Optional[migrated_on] => String, Optional[reason] => Enum['Initial','Manual','Recommended'], Optional[reason_l10n] => String, }]]]",
