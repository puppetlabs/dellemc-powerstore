...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    current_unix_directory_service:          {
      type:      "Optional[Optional[Enum['None','NIS','LDAP','Local_Files','Local_Then_NIS','Local_Then_LDAP']]]",
    ...
    default_unix_user:          {
      type:      "Optional[Optional[String[0,63]]]",
    ...
    default_windows_user:          {
      type:      "Optional[Optional[String[0,1023]]]",
    ...
    operational_status:          {
      type:      "Optional[Optional[Enum['Stopped','Starting','Started','Stopping','Failover','Degraded','Unknown']]]",
