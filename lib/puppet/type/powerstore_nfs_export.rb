...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    anonymous_gid:          {
      type:      "Optional[Optional[Integer[-2147483648,2147483647]]]",
    ...
    default_access:          {
      type:      "Optional[Optional[Enum['No_Access','Read_Only','Read_Write','Root','Read_Only_Root']]]",
    ...
    description:          {
      type:      "Optional[Optional[String[0,511]]]",
    ...
    min_security:          {
      type:      "Optional[Optional[Enum['Sys','Kerberos','Kerberos_With_Integrity','Kerberos_With_Encryption']]]",
