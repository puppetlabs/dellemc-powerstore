...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    access_policy:          {
      type:      "Optional[Optional[Enum['Native','UNIX','Windows']]]",
    ...
    access_type:          {
      type:      "Optional[Optional[Enum['Snapshot','Protocol']]]",
    ...
    creator_type:          {
      type:      "Optional[Optional[Enum['Scheduler','User']]]",
    ...
    description:          {
      type:      "Optional[Optional[String[0,255]]]",
    ...
    filesystem_type:          {
      type:      "Optional[Optional[Enum['Primary','Snapshot']]]",
    ...
    folder_rename_policy:          {
      type:      "Optional[Optional[Enum['All_Allowed','SMB_Forbidden','All_Forbidden']]]",
    ...
    grace_period:          {
      type:      "Optional[Optional[Integer[-1,2147483647]]]",
    ...
    locking_policy:          {
      type:      "Optional[Optional[Enum['Advisory','Mandatory']]]",
    ...
    smb_notify_on_change_dir_depth:          {
      type:      "Optional[Optional[Integer[1,512]]]",
