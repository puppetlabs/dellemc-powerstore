...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    destination_resource_type:          {
      type:      "Optional[Optional[Enum['volume','volume_group']]]",
    ...
    error:          {
      type:      "Optional[Optional[Struct[{Optional[arguments] => Array[String], Optional[code] => String, Optional[message_l10n] => String, }]]]",
    ...
    progress_percentage:          {
      type:      "Optional[Optional[Integer[0,2147483647]]]",
    ...
    state:          {
      type:      "Optional[Optional[Enum['Scheduled','Paused','Queued','In_Progress','Mirror_Enabled','Ready_To_Start_Copy','Copy_In_Progress','Ready_For_Cutover','Cutover_In_Progress','Import_Completed','Cancelled','Failed','Cancel_Failed','Cancel_In_Progress','Cleanup_In_Progress','Cleanup_Failed','Invalid','Cleanup_Required','Import_Completed_With_Errors','Import_Cutover_Incomplete']]]",
