...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    add_initiators:          {
      type:      "Optional[Optional[Array[Struct[{Optional[chap_single_password] => String[12,64], Optional[chap_single_username] => String[1,64], port_name => String, port_type => Enum['iSCSI','FC'], Optional[chap_mutual_password] => String[12,64], Optional[chap_mutual_username] => String[1,64], }]]]]",
