...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    host_initiators:          {
      type:      "Optional[Array[Struct[{Optional[port_type] => Enum['iSCSI','FC'], Optional[port_type_l10n] => String, Optional[active_sessions] => Array[Struct[{Optional[veth_id] => String, Optional[appliance_id] => String, Optional[bond_id] => String, Optional[eth_port_id] => String, Optional[fc_port_id] => String, Optional[node_id] => String, Optional[port_name] => String, }]], Optional[chap_mutual_username] => String[1,64], Optional[chap_single_username] => String[1,64], Optional[port_name] => String, }]]]",
    ...
    modify_initiators:          {
      type:      "Optional[Array[Struct[{Optional[port_name] => String, Optional[chap_mutual_password] => String[12,64], Optional[chap_mutual_username] => String[1,64], Optional[chap_single_password] => String[12,64], Optional[chap_single_username] => String[1,64], }]]]",
