...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    description:          {
      type:      "Optional[Optional[String[1,128]]]",
    ...
    location_history:          {
      type:      "Optional[Optional[Array[Struct[{Optional[to_appliance_id] => String, Optional[from_appliance_id] => String, Optional[migrated_on] => String, Optional[reason] => Enum['Initial','Manual','Recommended'], Optional[reason_l10n] => String, }]]]]",
      desc:      "Filtering on the fields of this embedded resource is not supported.",
    },
    logical_unit_number:          {
      type:      "Optional[Optional[Integer[0,16383]]]",
    ...
    node_affinity:          {
      type:      "Optional[Optional[Enum['System_Select_At_Attach','System_Selected_Node_A','System_Selected_Node_B','Preferred_Node_A','Preferred_Node_B']]]",
    ...
    sector_size:          {
      type:      "Optional[Optional[Integer[512,4096]]]",
    ...
    state:          {
      type:      "Optional[Optional[Enum['Ready','Initializing','Offline','Destroying']]]",
    ...
    type:          {
      type:      "Optional[Optional[Enum['Primary','Clone','Snapshot']]]",
