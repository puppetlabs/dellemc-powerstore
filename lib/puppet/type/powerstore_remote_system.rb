...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    data_connection_state:          {
      type:      "Optional[Optional[Enum['OK','Partial_Data_Connection_Loss','Complete_Data_Connection_Loss','Status_Not_Available','No_Targets_Discovered','Initializing']]]",
    ...
    data_network_latency:          {
      type:      "Optional[Optional[Enum['Low','High']]]",
    ...
    discovery_chap_mode:          {
      type:      "Optional[Optional[Enum['Disabled','Single','Mutual']]]",
...
",
    ...
    state:          {
      type:      "Optional[Optional[Enum['OK','Update_Needed','Management_Connection_Lost']]]",
    ...
    type:          {
      type:      "Optional[Optional[Enum['PowerStore','Unity','VNX','PS_Equallogic','Storage_Center','XtremIO']]]",
