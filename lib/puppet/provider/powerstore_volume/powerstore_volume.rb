...
context.debug("Entered get")
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation volumeCollectionQuery")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/volume', 'Get','[application/json]')
  end


  def self.invoke_create(context, resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation volumeCreate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/volume', 'Post','[application/json]')
  end


  def self.invoke_update(context, resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation volumeModify")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/volume/%{id}', 'Patch','[application/json]')
  end


  def self.invoke_delete(context, resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation volumeDelete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/volume/%{id}', 'Delete','[application/json]')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation volumeInstanceQuery")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/volume/%{id}', 'Get','[application/json]')
  end
