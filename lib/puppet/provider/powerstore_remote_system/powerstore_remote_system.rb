...
class Puppet::Provider::PowerstoreRemote_system::PowerstoreRemote_system
...
context.debug("Entered get")
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/remote_system', 'Get','[application/json]')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/remote_system', 'Post','[application/json]')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/remote_system/%{id}', 'Patch','[application/json]')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/remote_system/%{id}', 'Delete','[application/json]')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/remote_system/%{id}', 'Get','[application/json]')
  end
