...
class Puppet::Provider::PowerstoreLocal_user::PowerstoreLocal_user
...
context.debug("Entered get")
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/local_user', 'Get','[application/json]')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/local_user', 'Post','[application/json]')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/local_user/%{id}', 'Patch','[application/json]')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/local_user/%{id}', 'Delete','[application/json]')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/api/rest/local_user/%{id}', 'Get','[application/json]')
  end
