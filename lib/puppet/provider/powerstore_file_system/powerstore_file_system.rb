...
class Puppet::Provider::Powerstorefile_system::PowerstoreFile_system
...
context.debug("Entered get")
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/file_system', 'Get','[application/json]')
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/file_system', 'Post','[application/json]')
  end
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/file_system/%{id}', 'Patch','[application/json]')
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/file_system/%{id}', 'Delete','[application/json]')
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/file_system/%{id}', 'Get','[application/json]')
  end
