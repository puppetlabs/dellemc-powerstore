...
context.debug("Entered get")
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation hostCollectionQuery")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/host', 'Get','[application/json]')
  end


  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation hostCreate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/host', 'Post','[application/json]')
  end


  def self.invoke_update(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation hostModify")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/host/%{id}', 'Patch','[application/json]')
  end


  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation hostDelete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/host/%{id}', 'Delete','[application/json]')
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation hostInstanceQuery")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = ""
    ...
    self.call_op(path_params, query_params, header_params, body_params, '/host/%{id}', 'Get','[application/json]')
  end
